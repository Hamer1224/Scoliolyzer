...
class ScoliosisAnalyzer: def init(self, master): self.master = master self.master.title("Scoliosis Analyzer") self.master.geometry("900x1100")
...
if name == 'main': root = Tk() app = ScoliosisAnalyzer(root) root.mainloop()
